...
#[allow(dead_code)]
pub static TARGET: &str = "wasm32-wasip1";
...
#[allow(dead_code)]
pub static RUSTC: &str = "/Users/life_mac_29/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/Users/life_mac_29/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustdoc";
...
#[doc=r#"The output of `/Users/life_mac_29/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.88.0-nightly (d5b4c2e4f 2025-04-02)";
#[doc=r#"The output of `/Users/life_mac_29/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustdoc -V`; empty string if `/Users/life_mac_29/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.88.0-nightly (d5b4c2e4f 2025-04-02)";
